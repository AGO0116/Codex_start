...
`robot-nav-viewer` は、ブラウザ上で、ロボットの移動操作、経路計画、経路追従などを、このエディタ上で作成できる3Dマップや、PLATEAU3D都市モデルのオープンデータを用いて試行出来る3Dビューアーです。
...
研究・検証用の軽量ビューアーとして、ロボット、地形、障害物、経路生成、追従制御などを入れ替えながら、ネット上の3DTilesデータを使って試行できます。
